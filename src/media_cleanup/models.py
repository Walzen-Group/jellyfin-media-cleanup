...
def build_summary(result: CleanupResult, mode: str = "all", added_threshold: int = 12) -> SummaryModel:
    ...
    return SummaryModel(
        recent=_make_category(
            ...
            series_size=_season_size(result.recent_seasons_matched),
        ),
        old=_make_category(
            ...
            series_size=_season_size(result.old_seasons_matched),
        ),
        ...
        kept=_make_category(
            ...
            series_size=_season_size(result.kept_season_matches),
        ),
